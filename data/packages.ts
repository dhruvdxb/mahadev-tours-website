...
export const tourPackages: TourPackage[] = [
  ...
  {
    id: 9,
    title: "Ashtavinayak & Dagdusheth Ganpati Darshan",
    description: "Spiritual journey covering all 8 Ashtavinayak temples (Lenyadri, Ozar, Ranjangaon, Siddhatek, Morgaon, Theur, Pali, Mahad) plus Dagdusheth Halwai Ganpati in Pune.",
    duration: "3 Days (2 Nights)",
    departureDates: ["August 13 (Thursday Night)"],
    vehicle: "Sleeper AC Bus",
    inclusions: ["1-time Tea/Breakfast", "2-time Meals", "4-Person Room Stay"],
    price: { startingFrom: 5400, details: "₹5,400 (Upper Berth) / ₹5,900 (Lower Berth)" },
    notes: "Sightseeing at own cost. Bus Departure from Lal Ganesh Mandir, Palanpur Patiya, Surat.",
    location: "Maharashtra",
    categories: ["Religious"],
    image: "/Images/Ashtavinayak.png",
    gallery: ["/Images/Ashtavinayak.png"],
    itinerary: [
      { day: "Day 0", title: "Departure from Surat", details: "Night departure from Lal Ganesh Mandir, Palanpur Patiya, Surat. Overnight journey towards Maharashtra." },
      { day: "Day 1", title: "Ashtavinayak Darshan Begins", details: "Arrival in Maharashtra. Begin the holy darshan sequence covering initial Ashtavinayak temples. Meals and night stay included." },
      { day: "Day 2", title: "Pune & Ashtavinayak", details: "Continue visiting the remaining Ashtavinayak temples. Special darshan at the famous Dagdusheth Halwai Ganpati temple in Pune. Night stay." },
      { day: "Day 3", title: "Final Darshan & Return", details: "Complete the darshan of the remaining holy sites. Evening departure for the return journey back to Surat." }
    ]
  }
];